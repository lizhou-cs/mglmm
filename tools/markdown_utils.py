...
<span class="highlighted-text" style='color:rgb(107, 100, 239)'>MGLMM</span>

"""

examples = [
    ["Could you provide me with a detailed analysis of this photo? Please output with interleaved segmentation masks"
     " for the corresponding parts of the answer.", "./output/images/tokyo.jpg", ],
    ["Could you give a comprehensive explanation of what can be found within this picture? "
     "Please output with interleaved segmentation masks for the corresponding phrases.",
        "./output/images/mansion.jpg", ],
    ["Can you please segment the yacht ?", "./output/images/yacht.jpg", ],
    ["Can you segment the hot air balloon ?", "./output/images/balloon.jpg", ],
    ["Could you please give me a detailed description of the image ?", "./output/images/beetle.jpg", ],
    ["Could you provide me with a detailed analysis of this photo? "
     "Please output with interleaved segmentation masks for the corresponding parts of the answer.",
        "./output/images/joker.jpg", ],
    ["Can you segment what the person is using to ride ?", "./output/images/surfer.jpg", ],
    ["Can you segment the water around the person ?", "./output/images/paddle.jpg", ],
    ["Could you provide me with a detailed analysis of this photo? "
     "Please output with interleaved segmentation masks for the corresponding parts of the answer.",
        "./output/images/snow.jpg", ],
    ["What is she doing in this image ?", "./output/images/japan.jpg", ], ]

title = "MGLMM : Grounding Large Multimodal Model"
...
article = """
<center> This is the online demo of MGLMM from MBZUAI. \n </center>
"""
