...
class CocoCapDataset(OSSDataset):
    ...
    def __init__(self, dataset_dir, tokenizer, global_image_encoder, epoch_samples=10000, precision="fp32",
        ...
        super(CocoCapDataset, self).__init__()
    ...
    def _load_annotations(self, annotation_file):
        ...
        ann_ids = ann_ids[:1000] if self.validation else ann_ids # Limiting anns to 1000(optional) for validation
        data_infos = []
    ...
    def __getitem__(self, idx):
        ...
        ann_id = self.coco_api.getAnnIds()[idx]
