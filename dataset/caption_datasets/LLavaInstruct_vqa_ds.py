...
class LLaVAInstructDataset(OSSDataset):
    ...
    def __init__(self, dataset_dir, tokenizer, global_image_encoder, epoch_samples=10000, precision="fp32",
        ...
        print('\033[92m' + "----CAP-{}: Number of samples: {}----".format(mode, len(self.data_infos)) + '\033[0m')
    ...
    def __getitem__(self, idx):
        ...
        image_path = os.path.join(self.image_folder, data_info["image"])
        ...
        conv_ann = data_info["conversations"]
